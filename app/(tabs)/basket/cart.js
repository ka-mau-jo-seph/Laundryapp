...
const cart = () => {
  ...
  return (
    <ScrollView>
      ...
      <Text style={{ padding: 10 }}>Basket Items</Text>
      ...
      <View style={{flexDirection:"row",padding:15,alignItems:"center",gap:12,marginTop:30}}>
          ...
          <Pressable
          onPress={() => router.replace("/home/address")}
           style={{backgroundColor:"#0066b2",padding:15,borderRadius:10,flex:1,alignSelf:"center"}}>
